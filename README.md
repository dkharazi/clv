...
Usually, there isn't much of a difference in CLV across different demographic attributes. Maybe, the mean CLV for a set of customers in one demographic is different compared to the mean CLV for a set of customers in a different demographic. For example, maybe the mean CLV of older people is higher compared to the mean CLV of younger people. However, these differences in CLV only are marginal in most cases, especially compared with the differences in CLV within each group. In other words, any average CLV of a particular demographic is meaningless if the variance isn't provided as well.

Personas are a much more holistic concept than demographics alone. What’s not to like about the idea of being able to put a face to a customer segment? It’s much simpler to imagine marketing to *Harriet Housewife* and to compare her needs with those of *Working Wanda* or *Carpool Carla*. Managers just love the use of personas, since there’s something so intuitive about putting these cartoon characters up on a whiteboard and thinking about which ones you want to focus your acquisition efforts on.

As a result, managers and marketers behave as if these personas are a reasonable and adequate representation of their customer base. However, these personas are essentially just shorthand for customers' demographic attributes, which hasn't been as effective as segments based on CLV.

From a researcher’s perspective, personas are another way of categorizing people based on surface-level characteristics. In most cases, these surface-level characteristics don’t have much to do with a customer’s true future worth or CLV to the company. If we're interested in actually gaining insights into our customer’s spending habits, then demographics and personas are the wrong tool. CLV would be a better tool.

Even in CLV analysis, we still need to profile our customer segments. But a customer-centric approach to segmentation is polar opposite to that of traditional marketers, who tend to start with predetermined segments (often based on demographics/personas) and ask, *"Which segments seem most attractive for selling our products?”* By contrast, the customer-centric marketer starts with individual-level CLVs and then asks, *"What are the characteristics that make our top customers different from our bottom customers?*" This is a key distinction in mindset as well as practice. 

Most of this research has been done by Peter Fader and Bryce Hardie, which is outlined in [Peter Fader's Customer Centricity Playbook](https://wsp.wharton.upenn.edu/book/customer-centricity-playbook/). For more details about customer-centric strategies, assumptions, and findings, refer to Fader's playbook.
