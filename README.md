...
Refer to [these slides](http://cdn.oreillystatic.com/en/assets/1/event/85/Case%20Study_%20What_s%20a%20Customer%20Worth_%20Presentation.pdf) from Roberto Medri fro a deeper, high-level explanation about customer lifetime value. For a lower-level understanding of CLV models and how they're built, refer to [this terrific talk](https://www.youtube.com/watch?v=guj2gVEEx4s&ab_channel=FirstMarkCapital) by Peter Fader. Or, refer to [this talk](https://www.youtube.com/watch?v=0iLQCNYdNb4&ab_channel=TalksatGoogle) by Peter Fader for illustrations of how we can target and apply separate customer targeting tactics on different CLV segments of customers.
